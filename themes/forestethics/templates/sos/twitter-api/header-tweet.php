...
$access_token			= '1876084868-dF0eaO9O4kCkq3psG6Sda37rqRYnSBYzPV19rPx';
$access_token_secret		= 'nIblaFROGDQrRoxgYEcPyZJrdDTfdmwCLEuKSW8g0';
$consumer_key			= 'ZlIzADxd21m1vyIeppbiA';
$consumer_secret		= 'LowmWaCGp672sspfFm3IWCCd2PbaPDcwtWgMH0SE';

// Some variables
$twitter_username 		= 'tarsandssos';
...
if (!$twitter_debug) {
	...
	if ( (time() - $twitter_cache_time < $cache_created_on) && $twitter_caching) {
		...
		if (isset($twitter_stream[0]->text)) {
			...
			if($file = @fopen(dirname(__FILE__).'/'.$twitter_cache_file, 'w')){
