...
<div class='lightbox-wrapper' id="FE_wrap">
    ...
    <a class="give-btn-link" href="https://forestethics.netdonor.net/ea-action/action?ea.client.id=1818&ea.campaign.id=23742&ea.tracking.id=lightbox">
      <img src="/<?php echo($theme_path);?>/images/fe_2013_eoy/give_now.png" alt="" />
    </a>
...
<div class="lightbox-wrapper" id="FEA_wrap">
   <div class="lightbox-inner">
    ...
    <div class="form-holder">
    <a class="give-btn-link" href="https://forestethicsadvocacy.netdonor.net/ea-action/action?ea.client.id=1818&ea.campaign.id=23744&ea.tracking.id=lightbox">
      <img src="/<?php echo($theme_path);?>/images/fe_2013_eoy/give_now.png" alt="" />
    </a>
...
<script type='text/javascript'>   
  ...
  jQuery(document).ready(function()
    {    
      ...
      if(myCountry == "CA"){
        geo_ip_global = "FEA";     
        $('.home-slide-link').attr('href','https://forestethicsadvocacy.netdonor.net/ea-action/action?ea.client.id=1818&ea.campaign.id=23744&ea.tracking.id=homepage');
      }
      else{
        geo_ip_global = "FE";      
        $('.home-slide-link').attr('href','https://forestethics.netdonor.net/ea-action/action?ea.client.id=1818&ea.campaign.id=23742&ea.tracking.id=homepage');
      }
      check_cookie();
    });
