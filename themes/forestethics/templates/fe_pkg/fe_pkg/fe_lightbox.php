...
<div style="display: none;" id="fe2013-popup">
  ...
  <div id="fe2013-popup-container">
      <div id="fe2013-popup-content">
        <span id="fe2013-popup-close-btn"><img src="fe2013_lightbox_assets/close.png"/></span>
        <a href="#">
          <img alt="fe" src="fe2013_lightbox_assets/background.png">
        </a>
...
</div><span class="eaSubmitResetButtonGroup" id="eaFormButtonGroup_1"><input type="image" src="fe2013_lightbox_assets/submit.png"class="eaSubmitButton" value="Send"></input></span>
</form>
